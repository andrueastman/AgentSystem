...
--
-- Table structure for table `commentslist`
--
...
CREATE TABLE `commentslist` (
  ...
  CONSTRAINT `FK_Comment` FOREIGN KEY (`commentid`) REFERENCES `coments` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_User` FOREIGN KEY (`UserId`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `commentslist`
--

LOCK TABLES `commentslist` WRITE;
/*!40000 ALTER TABLE `commentslist` DISABLE KEYS */;
/*!40000 ALTER TABLE `commentslist` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-01-22 17:25:56
