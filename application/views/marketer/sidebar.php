	<div id="sidebar">
                  ...
                  <li><h3><a href="#" class="user">Agents</a></h3>
          				<ul>
                            <li><a href="#" class="useradd">Add agent</a></li>
            				<li><a href="#" class="search">Find agent</a></li>
                            <li><a href="#" class="online">Agents online</a></li>
                        </ul>
                    </li>
				</ul>       
